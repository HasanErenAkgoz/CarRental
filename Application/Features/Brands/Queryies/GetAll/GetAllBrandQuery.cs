...
{
    public class GetAllBrandQuery : IRequest<GetAllResponse<GetAllBrandListItemDto>>
    {
        ...
        public class GetAllBrandQueryHandler : IRequestHandler<GetAllBrandQuery, GetAllResponse<GetAllBrandListItemDto>>
        {
            ...
            public async Task<GetAllResponse<GetAllBrandListItemDto>> Handle(GetAllBrandQuery request, CancellationToken cancellationToken)
            {
                ...
                GetAllResponse<GetAllBrandListItemDto> response = _mapper.Map<GetAllResponse<GetAllBrandListItemDto>>(brands);
