    ...
    where TRequest : IRequest<TResponse>, ICachableRequest
{
    ...
    public CachingBehavior(IDistributedCache distributedCache, IOptions<CacheSettings> cacheSettingsOptions, ILogger<CachingBehavior<TRequest, TResponse>> logger)
    {
